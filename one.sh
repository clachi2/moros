...
#qemu-system-x86_64 -m 32 -smp 2 -drive file=disk-1.img,format=raw -audiodev coreaudio,id=a0 -machine pcspk-audiodev=a0 -netdev user,id=e0,hostfwd=tcp::8081-:80 -device rtl8139,netdev=e0, -serial stdio -cpu core2duo
