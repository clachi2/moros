...
MOROS (Minimal Obscure Rust Operating System) ist ein in der Programmiersprache \texttt{Rust} entwickeltes Betriebssystem, das bewusst minimalistisch gehalten ist.
...
Seine Entwicklung in \texttt{Rust} bringt den Vorteil mit sich, dass Speicher- und Typsicherheit von Beginn an fest im System verankert sind.
...
Dies erleichtert das Verständnis und ermöglicht es, einzelne Bausteine gezielt zu verändern oder auszutauschen.
\end{subsection}
