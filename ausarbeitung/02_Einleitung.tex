...
einheitlichen Basis auszuführen~\cite{tanenbaum2015modern}.
Gleichzeitig sind sie traditionell ein Forschungs- und Lehrfeld, um grundlegende Konzepte der Systemsoftware zu erproben~\cite{osdev_wiki, hobby_os_wiki}.
Insbesondere minimalistische Betriebssysteme erlauben es, Funktionen von Grund auf zu verstehen und gezielt zu erweitern.
In diesem Seminarprojekt haben wir uns mit MOROS (Minimal Obscure Rust Operating System) beschäftigt~\cite{moros_github}.
...
\begin{subsection}{Stellungnahme zu KI}\label{sec:KI}
Im Rahmen dieser Bachelorarbeit wurde zur vereinzelten Vervollständigung von Code und Text künstliche Intelligenz verwendet.
\end{subsection}
